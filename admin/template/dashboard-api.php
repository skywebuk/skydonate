    ...
    <form class="skydonation-api-form" method="post" action="">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <input <?php echo esc_attr(LDIS); ?> type="text" name="zakat_calc_api" id="zakat_calc_api" value="<?php echo esc_attr(get_option('zakat_calc_api', '')); ?>">
                    <p class="description">
            ...
            <tr>
                ...
                <td>
                    <input <?php echo esc_attr(LDIS); ?> type="text" name="currencyapi_key" id="currencyapi_key" value="<?php echo esc_attr(get_option('currencyapi_key', '')); ?>">
                    <p class="description">
        ...
        <br>
        <p>
            <button type="submit" class="skydonation-button" <?php echo esc_attr(LDIS); ?>>
